...
void Init(){
    ...
    // n=4;
    // a[1]=Player(" 洛可可 ",7,0,0);
    // a[2]=Player(" 布兰特 ",8,0,-1);
    // a[3]=Player("  菲比  ",12,2,-1);
    // a[4]=Player("  赞妮  ",10,0,-2);
    // for(int i=1;i<=n;i++)b[i]=i;
    // random_shuffle(b+1,b+n+1);
    ...
    // Day 10
    n=4;
    a[1]=Player(" 布兰特 ",8,0,0);
    a[2]=Player(" 守岸人 ",6,0,-1);
    a[3]=Player(" 卡卡罗 ",1,2,-1);
    a[4]=Player("  赞妮  ",10,0,-2);
    for(int i=1;i<=n;i++)b[i]=i;
    random_shuffle(b+1,b+n+1);
...
T = 10000000
|   姓名   |  1位率  |  2位率  |  3位率  |  4位率  | 平均位次 |
|  洛可可  | 27.88 % | 26.86 % | 26.23 % | 19.03 % |  2.3641  |
|  布兰特  | 29.01 % | 27.71 % | 25.80 % | 17.49 % |  2.3177  |
|   菲比   | 26.00 % | 26.45 % | 27.44 % | 20.12 % |  2.4168  |
|   赞妮   | 17.12 % | 18.98 % | 20.54 % | 43.36 % |  2.9015  |

Day 9:
T = 10000000
|   姓名   |  1位率  |  2位率  |  3位率  |  4位率  | 平均位次 |
|  卡卡罗  | 24.50 % | 31.32 % | 33.35 % | 10.83 % |  2.3051  |
|  守岸人  | 26.71 % | 25.14 % | 23.92 % | 24.23 % |  2.4566  |
|  布兰特  | 27.51 % | 23.28 % | 22.27 % | 26.94 % |  2.4865  |
|   赞妮   | 21.28 % | 20.27 % | 20.46 % | 38.00 % |  2.7518  |

Day 10:
T = 10000000
|   姓名   |  1位率  |  2位率  |  3位率  |  4位率  | 平均位次 |
|  布兰特  | 28.92 % | 24.53 % | 22.50 % | 24.04 % |  2.4166  |
|  守岸人  | 29.16 % | 27.30 % | 23.44 % | 20.10 % |  2.3447  |
|  卡卡罗  | 23.70 % | 30.66 % | 36.09 % | 9.56  % |  2.3151  |
|   赞妮   | 18.22 % | 17.51 % | 17.97 % | 46.30 % |  2.9236  |
*/