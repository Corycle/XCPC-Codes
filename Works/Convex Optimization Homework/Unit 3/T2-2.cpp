...
alpha=0.49 , beta=0.1 , n=57 , x*=(-0.346573,-8.24054e-18) , f(x*)=2.55927
alpha=0.49 , beta=0.3 , n=22 , x*=(-0.346573,-3.53989e-09) , f(x*)=2.55927
alpha=0.49 , beta=0.5 , n=30 , x*=(-0.346573,-4.54355e-08) , f(x*)=2.55927
alpha=0.49 , beta=0.7 , n=16 , x*=(-0.346573,7.86146e-09) , f(x*)=2.55927
alpha=0.49 , beta=0.9 , n=26 , x*=(-0.346573,-2.6447e-08) , f(x*)=2.55927
*/